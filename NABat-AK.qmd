...
For the remaining three species, Silver-haired Bat (λ = 1.05, 0.95–1.17), and California Myotis (λ = 1.16, 1.00–1.35), the 95% credible interval for λ overlapped 1, indicating that no directional change in occupancy could be detected.
...
occ_tbl <- tibble::tribble(
  ...
  "Distance to road",     " ", "-0.49 (-0.91, -0.16)", "—",                    "—",                 "—",                  "-0.61 (-1.35, -0.18)", "—",
  "Distance to road ",    " ",                    "-0.42 (-0.73, -0.07)", "—",                    "—",                 "—",                  "—",                    "-0.78 (-1.40, -0.13)",
  "Percent clutter",      " ",                    "—",                    "0.22 (0.13, 0.32)",    "0.11 (0.02, 0.19)", "—",                  "0.16 (0.08, 0.25)",    "—",
  "Nightly temperature",  " ",    "0.47 (0.36, 0.57)",    "0.23 (0.14, 0.33)",    "—",                 "0.24 (0.14, 0.34)",  "0.15 (0.06, 0.24)",    "—",
  "Julian night",         " ",    "0.18 (0.09, 0.27)",    "-0.20 (-0.29, -0.12)", "—",                 "0.28 (0.19, 0.38)",  "0.13 (0.05, 0.22)",    "0.11 (0.01, 0.22)"
)
...
Main questii: what do we need to change to improve the power of these analyses. REcommnedations to improve stats)

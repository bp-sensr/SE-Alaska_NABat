...
White-nose Syndrome (WNS) is a deadly fungal disease caused by the fungus *Pseudogymnoascus destructans* (*Pd*) that affects hibernating bats. As of 2026, WNS has been confirmed in 42 U.S. states, nine Canadian provinces, and the Northwest Territories [@u.s.fishandwidlifeservice; @segers] . *Pd* , but not WNS, has been detected in 5 additional states and within British Columbia( @fig-WNS: @segers ; @u.s.fishandwidlifeservice ). Continued monitoring of populations in Alaska is critical as *Pd* and WNS continue to spread throughout the region.
...
Wind energy development is a substantial source of bat mortality in North America; one 2023 estimate placed U.S. turbine-related deaths at 926,856 [@nasbrst2024]. Migratory tree-roosting species (the hoary bat *Lasiurus cinereus*, eastern red bat *L. borealis*, and silver-haired bat *Lasionycteris noctivagans*) account for the majority of fatalities, representing roughly 73% of reported carcasses nationally [@zimmerling2016]. Two of these, the silver-haired and hoary bats, occur in Southeast Alaska. Modeling suggests turbine collisions alone could reduce the North American hoary bat population by up to 90% over 50 years [@frick2017]. Wind generation in Alaska is concentrated along the Railbelt, on Kodiak Island, and in rural western and northern communities, with little development in the Southeast to date [@hoen]. As renewable energy expands, however, future projects would pose a collision risk to the region's migratory bats, whose distribution and seasonal movements there remain poorly understood.

![Current wind turbines across the region. Data from Canadian Wind Turbine database and U.S. Wind Turbine database (Hoen et al., n.d.; Natural Resources Canada, n.d.).](Figures/WindTurbines-NNWRegion.JPG){#fig-turbines}
...
Two to four stationary detectors were deployed across at least two quadrants per grid cell for a minimum of seven nights. Sites were selected to maximize species detection and recording quality across different habitat types (see [@rae2024] for full site selection criteria). Deployments occured between mid-May and mid-July, after bats have emerged from hibernation but before young bats are volant. Sites and timing are kept consistent between years to minimize variability in conditions affecting bat activity.

...
The reduced survey effort in 2025 was the result of staffing cuts by the US Forest Service and staffing levels are unlikely to improve in the near future. Maintainign the sampling in the sites and grid cells that have the most amount of continuous data is vital to enrugin that we can continue to detect changes in the populations, expecially given the imminent threat of white nose syndrome. if need to reduce the number of grids would focus on keeping the grids that have been sampled the longest. Efforts can also be made to join efforts with other agencies to continue monitoring at current or new sites. One example that is being explored in BC and Alberta is engaging with industry partners (mines and wind development) to have coordinated monitorign efforts at their sites and getting them to contriubte to the hub and overall work.

Efforts to help reduce the work it takes to deploy the grid cells are mainyl focuse aroudn efficiencies in deployment. Grid leaders should be continued to be encouraged to use Survey123 as a form to simplify their deployment of sites. In 2024 and 2025 the online platform was not used consistently among all grids. In 2026 we can view efficiencies surrounding weather data used, specifically evaluating whether the continued use of temperature and humidity detectors at the site offer simialr results to using weather data from clsoest weather stations.
...
Overall Alaska species seem to be pretty stable, with even potentail increases for bats like LANO nad MYCA

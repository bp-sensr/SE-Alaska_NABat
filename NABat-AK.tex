...
0.95--1.17), and California Myotis (λ = 1.16, 1.00--1.35)
(Table~\ref{tbl-occ-trends}), the 95\% credible interval for λ
overlapped 1, indicating that no directional change in occupancy could
be detected.

\begin{longtable}[l]{lll}

\caption{\label{tbl-occ-trends}Occupancy trend estimates. Bolded rows
show the estimates where lambada did not include 1 which suggest a
changing trend}

\tabularnewline

\toprule
Species & Trend Slope (95\% CI) & λ (95\% CI)\\
\midrule
Hoary Bat &  & \\
Silver-haired Bat & 0.0085 (0.0009, 0.0160) & 1.05 (0.95, 1.17)\\
California Myotis & 0.0158 (0.0069, 0.0250) & 1.16 (1.00, 1.35)\\
\textbf{Long-eared Myotis} & \textbf{0.0276 (0.0174, 0.0381)} & \textbf{1.25 (1.05, 1.50)}\\
\textbf{Little Brown Myotis} & \textbf{0.0142 (0.0090, 0.0200)} & \textbf{1.10 (1.03, 1.19)}\\
\addlinespace
\textbf{Long-legged Myotis} & \textbf{0.0246 (0.0144, 0.0346)} & \textbf{1.43 (1.18, 1.77)}\\
\textbf{Yuma Myotis} & \textbf{0.0151 (0.0065, 0.0233)} & \textbf{1.44 (1.17, 1.79)}\\
\bottomrule
...
effects were mixed across species (Table~\ref{tbl-occ-covariates}).

\begin{table}[H]

\caption{\label{tbl-occ-covariates}Covariates}

\centering{

\includegraphics[width=6.51in,height=\textheight,keepaspectratio]{figures/occ_covariates.png}
...
near future. Maintainign the sampling in the sites and grid cells that
have the most amount of continuous data is vital to enrugin that we can
continue to detect changes in the populations, expecially given the
imminent threat of white nose syndrome. if need to reduce the number of
grids would focus on keeping the grids that have been sampled the
longest. Efforts can also be made to join efforts with other agencies to
continue monitoring at current or new sites. One example that is being
explored in BC and Alberta is engaging with industry partners (mines and
wind development) to have coordinated monitorign efforts at their sites
and getting them to contriubte to the hub and overall work.

Efforts to help reduce the work it takes to deploy the grid cells are
mainyl focuse aroudn efficiencies in deployment. Grid leaders should be
continued to be encouraged to use Survey123 as a form to simplify their
deployment of sites. In 2024 and 2025 the online platform was not used
consistently among all grids. In 2026 we can view efficiencies
surrounding weather data used, specifically evaluating whether the
continued use of temperature and humidity detectors at the site offer
simialr results to using weather data from clsoest weather stations.

Species ranges continue to expand and a review of the data, specifically
looking for new potentail species would be prudent. Specifically
lookinga t the Big Borwn Bat. This bat has very similar calls to that of
LANO, so we can explore using bioacoustics to do general checks for
species for going out and catching the bats will be the only way to
confirm range expansion.

Overall Alaska species seem to be pretty stable, with even potentail
increases for bats like LANO nad MYCA
...
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-3190713865.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2878420209.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-950746085.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-4079169987.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2427323019.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-359804971.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-3695743881.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-1493695761.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-3941761601.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2730898759.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-3987187980.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-3555136292.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-3750373898.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2633679632.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2306693806.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-79436506.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-378845605.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2874082935.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2053734589.png}}
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-4053125643.png}}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/206_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/206_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/5006_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/5006_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/18318_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/18318_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/31438_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/31438_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/33486_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/33486_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/34254_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/34254_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/34338_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/34338_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/47310_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/47310_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/117173_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/117173_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/154037_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/154037_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/203189_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/203189_hour.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/315563_bar.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Figures/AppendixB/315563_hour.png}
